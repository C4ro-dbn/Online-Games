    ...
    <div class="col-md-4 text-light">
        <?php if(count(Cart::getContent())): ?>
            ...
            <form action="" method="" align="center">
                ...
                <a href="<?php echo e(url('/Catalogo-Productos')); ?>" class="btn btn-dark">Agregar mas</a>

                <a href="<?php echo e(url('/Pago')); ?>" class="btn btn-warning">Continuar con la compra</a>
...
<?php /**PATH C:\xampp\htdocs\onlinegames\resources\views/carrito/index.blade.php ENDPATH**/ ?>